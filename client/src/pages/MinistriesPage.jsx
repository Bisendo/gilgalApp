...
const MinistriesPage = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get('http://localhost:4040/ministries')
      .then((response) => {
      ...
      .catch((error) => {
        ...
        setError('An error occurred while fetching ministries.');
        setLoading(false);
      });
  }, []);
        ...
        >
          ...
          <div className="relative z-10 text-center text-white h-full flex flex-col items-center justify-center">
            ...
            <p className="text-2xl mt-4 animate__animated animate__fadeIn animate__delay-1s">
              Serving the community through faith, love, and action.
            </p>
          </div>
        </section>
      </div>

      {/* Ministry List Section */}
      <section className="py-16 px-4 text-center">
        <h2 className="text-4xl font-semibold text-gray-800 mb-12">Explore Our Ministries</h2>
